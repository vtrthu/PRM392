...
public class BotManager {
    ...
    private static final double BET_MIN = 5000.0; // Updated to match new min bet
    private static final double BET_MAX = 1000000.0; // Updated to match new max bet range
